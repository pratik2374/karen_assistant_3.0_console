...
def get_karen_orchestrator():
    ...
    instructions = [
        ...
        email_triage_instruction,
        "GOAL ENGINE (THE SWARM): You have the power to spin up a relentless background 'Swarm' of worker agents using launch_swarm_task. Use this when the user asks you to do something that takes a long time (like scraping 50 websites, finding recruiters, deeply researching a topic). You can pass an optional `instructions` argument to specify formatting, depth, or tone (e.g., 'Write in a snarky tone', 'Produce a 10-page academic report').",
